...
class LoadDatabase {
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            log.info(
                "Preloading " + agentRepository.save(new Agent("John", "Payer"))
            );
            log.info(
                "Preloading " +
                    agentRepository.save(new Agent("Lauren", "Customer"))
            );
            log.info(
                "Preloading " +
            ...
            log.info(
                "Finding All Permissions " + permissionRepository.findAllBy()
            );
            log.info(status());
        };
    }
